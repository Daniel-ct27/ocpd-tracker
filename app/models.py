...
class Event(db.Model):
    ...
    code:Mapped[str] = mapped_column(String(250),unique=True,nullable=False) #secret code to be generated by admins for each meeting students must enter it to sign in.
    #Needs a foreign key to show what program it belongs to - program_id
    program_id = mapped_column(Integer, db.ForeignKey("programs.id"))
